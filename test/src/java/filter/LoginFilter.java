...
import context.AuthenticationHelper;
import model.admin;
...
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        /*if (session.getAttribute("account") == null) 
            res.sendRedirect("login_2");*/

        
        if (uri.endsWith(".jsp") && !uri.contains("Success.jsp") && !uri.contains("login_2.jsp") && !uri.contains("homeland1.jsp") && !uri.contains("inform1.jsp")){
            req.getRequestDispatcher("homeland2.jsp").forward(request, response);
        }
        /*if (uri.contains("inform.jsp") && "1".equals(username) && "1".equals(password)){
